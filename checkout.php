...
include "db.php";
if (!isset($_SESSION["uid"]) || $_SERVER["REQUEST_METHOD"] !== "POST" || !isset($_POST["total_count"])) {
...
include "header.php";
?>
<link rel="stylesheet" type="text/css" href="css/modern_auth.css">
<?php
	...
	<div class="container-fluid">
		<div class="row-checkout">
			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<div class="payment-selection" style="margin-bottom: 20px; background: #fff; padding: 15px; border-radius: 5px; border: 1px solid #ddd;">
							<label style="display: flex; align-items: center; gap: 10px; cursor: pointer; margin-bottom: 10px;">
								<input type="radio" name="payment_method" value="COD" checked onclick="togglePaymentFields(\'COD\')"> 
								<i class="fa fa-money" style="font-size: 20px; color: #4CAF50;"></i>
								<span>Cash on Delivery</span>
							</label>
							<label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
								<input type="radio" name="payment_method" value="Card" onclick="togglePaymentFields(\'Card\')"> 
								<i class="fa fa-credit-card" style="font-size: 20px; color: #2196F3;"></i>
						...
						<div id="card_details" style="display:none;">
							...
							<div class="row">
								<div class="col-50">
									...
									<input type="text" id="expdate" name="expdate" class="form-control" pattern="^((0[1-9])|(1[0-2]))\/(\d{2})$" placeholder="MM/YY" maxlength="5">
								</div>
								<div class="col-50">
				...
				while ($i <= $total_count) {
					...
					$product_id = intval($_POST['item_number_' . $i]);
					$amount_ = (float) $_POST['amount_' . $i];
					$quantity_ = max(1, intval($_POST['quantity_' . $i]));
			...
			<div class="col-25">
				<div class="container-checkout">
					...
					";
						...
						while ($i <= $total_count) {
							...
							$quantity_ = max(1, intval($_POST['quantity_' . $i]));
							$line_total = $amount_ * $quantity_;
							$total = $total + $line_total;

							echo "	

						<tr><td><p>$i</p></td><td><p>$item_name_</p></td><td ><p>$quantity_</p></td><td ><p>".rupee($line_total)."</p></td></tr>";
				...
				<h3>total<span class='price' style='color:black'><b>".rupee($total)."</b></span></h3>";
