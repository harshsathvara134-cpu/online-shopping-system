...
include "db.php";
if(isset($_POST["review_action"]) && isset($_POST["proId"])){
    ...
    <div class="col-md-8">
        <div id="reviews">
            ...
            if ($r_count > 0){
                ...
                echo'<div style="text-align: center; padding: 40px 10px; color: #888; border: 1px dashed #e0e0e0; border-radius: 4px; margin-top: 15px;">
                        <i class="fa fa-commenting-o" style="font-size: 36px; margin-bottom: 10px; color: #ccc;"></i>
                        <p style="margin: 0; font-size: 15px;">No Reviews yet. Be the first person to rate this product!</p>
                     </div>';
            }
...
if(isset($_POST["rating_reviews"]) && isset($_POST["proId"])){
    $p_id = intval($_POST["proId"]); 
    $rating_query = "SELECT ROUND(AVG(rating),1) AS avg_rating, COUNT(*) AS count FROM reviews WHERE product_id='$p_id'";
            $run_query = mysqli_query($con,$rating_query);
            $row = mysqli_fetch_array($run_query);
            ...
            ';
                ...
                <a class="review-link" href="#review-form">0 Review(s) | Add your review</a>';
            }
