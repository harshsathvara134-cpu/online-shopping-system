      ...
      {isOpen && (
        <div
          ...
          style={{
            position: 'absolute',
            top: 'calc(100% + 8px)',
            right: idPrefix === 'mobile' ? '0px' : 'auto',
            left: idPrefix === 'mobile' ? 'auto' : '50%',
            transform: idPrefix === 'mobile' ? 'none' : 'translateX(-50%)',
            width: '240px',
        ...
        >
          ...
          <div
            style={{
              position: 'absolute',
              top: '-6px',
              right: idPrefix === 'mobile' ? '20px' : 'auto',
              left: idPrefix === 'mobile' ? 'auto' : '50%',
              transform: idPrefix === 'mobile' ? 'rotate(45deg)' : 'translateX(-50%) rotate(45deg)',
              width: '10px',
              height: '10px',
              backgroundColor: 'white',
