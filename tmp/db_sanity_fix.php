...
fix_table($con, 'order_products', 'order_pro_id', 'INT(10) NOT NULL');
fix_table($con, 'orders_info', 'order_id', 'INT(10) NOT NULL');
fix_table($con, 'categories', 'cat_id', 'INT(100) NOT NULL');
fix_table($con, 'products', 'product_id', 'INT(100) NOT NULL');

echo "Database sanity check complete.\n";
?>
